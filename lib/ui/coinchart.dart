      ...
      children: <Widget>[
        ...
        FittedBox(
          ...
          children: <Widget>[
            Radio(
              value:
                  'https://min-api.cryptocompare.com/data/histominute?fsym=${widget.symbol}&tsym=USD',
            ...
            Radio(
              value:
                  'https://min-api.cryptocompare.com/data/histohour?fsym=${widget.symbol}&tsym=USD',
              activeColor: Colors.greenAccent,
              onChanged: (value) {
                setState(() {
                  url = value;
            ...
            Radio(
              value:
                  'https://min-api.cryptocompare.com/data/histoday?fsym=${widget.symbol}&tsym=USD',
              activeColor: Colors.greenAccent,
              onChanged: (value) {
                setState(() {
                  url = value;
