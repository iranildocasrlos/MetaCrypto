...
class _SecondScreen extends State<SecondScreen> {
  Future<String> fetchAvgPrice() async {
    var url =
        'https://min-api.cryptocompare.com/data/dayAvg?fsym=${widget.cryptoData.symbol}&tsym=USD';
    ...
    if (response.statusCode == 200) {
      ...
      if (responseJSON["USD"] != null) {
        return (responseJSON["USD"] as num).toStringAsFixed(2);
      }
    } else {
